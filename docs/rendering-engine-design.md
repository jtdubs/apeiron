...
- As the user zooms *in*, the engine occasionally snapshots the 4K canvas, downscales it to a reduced resolution to conserve VRAM, and pushes it to an off-screen Ring Buffer array.
