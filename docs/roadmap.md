...
- [ ] [Task 063: Reference Rebasing Engine (Dual-Orbit Perturbation)](tasks/063-reference-rebasing-engine.md)
...
- [x] [Task 045: Adaptive Dynamic Resolution Scaling (ADRS)](tasks/completed/045-adaptive-drs.md)
...
- [x] [Task 075: Refactor `math_accum.wgsl` Monolith Extraction](tasks/completed/075-math-accum-reorg.md)
