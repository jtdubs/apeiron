...
- **`useRenderStore`**: Highly configurable visual parameters like continuous/banded/histogram
  `ColoringMode`, `InteriorMode`, theme presets, lights, and Distance Estimation modes.
