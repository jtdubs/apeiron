...
- [Progressive Rendering & Performance Design](../../design/engine/temporal-pipeline.md)
...
- [ ] **Documentation Sync:** Ensure the final implementation matches `docs/design/engine/temporal-pipeline.md`.
